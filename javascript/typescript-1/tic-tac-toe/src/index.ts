...
const undo: HTMLButtonElement = document.querySelector('.undo-btn')!;
const redo: HTMLButtonElement = document.querySelector('.redo-btn')!;
const restart: HTMLButtonElement = document.querySelector('.restart-btn')!;
const wonTitle: HTMLDivElement = document.querySelector('.won-title')!;
const wonMessage: HTMLSpanElement = document.querySelector('.won-message')!;

const stack: { currentPlayer: string, field: Array<any> }[] = [{
  currentPlayer: 'r',
...
document.querySelector('.field')!.addEventListener('click', (event: any):void => {
  ...
  const currentPlayer: string = stack[stack.length - 1].currentPlayer === 'ch' ? 'r' : 'ch';
